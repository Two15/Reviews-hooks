...
const eventFilter = require('./middlewares/event_filter');
const actionParser = require('./middlewares/action_filter');
...
function handlerPOST(req, res, next) {
  req.github.eventHandler.call({ log: req.log }, req.body)
  .then(function() {
    res.send(201, 'OK');
    next();
  }, function(reason) {
